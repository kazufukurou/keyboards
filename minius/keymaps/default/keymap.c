...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = {
        ...
        { ___X___, ALT_ESC, MO1_TAB, SFT_SPC, KC_SPC,  KC_SPC,  SFT_ENT, MO2_BS,  KC_MINS, ___X___ }
    },
    [1] = {
        ...
        { ___X___, ___X___, _______, _______, _______, _______, _______, KC_0,    KC_PIPE, ___X___ }
    },
    [2] = {
        ...
        { ___X___, ___X___, _______, ___X___, ___X___, ___X___, RESET,   _______, KC_MUTE, ___X___ }
    }
};
