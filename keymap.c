 ...
 * |-------+-----+-----+-----+-----+-----+-----+-------+-----+-----+-----+-----|
 * |  Fn2  |Meta | Alt | Fn1 |Shift|   Space   |Sft/Ent|Left |Down | Up  |Right|
 * '---------------------------------------------------------------------------'
 */
[0] = {
  ...
  {F(2),    KC_LGUI, KC_LALT, F(1),    KC_LSFT, KC_SPC,  KC_SPC,  SFT_ENT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
/*
 * .-----------------------------------------------------------------------.
 * |     | F9  | F10 | F11 | F12 |     |     |Prev |Play |Next |     |Reset|
 * |-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----|
 * |     | F5  | F6  | F7  | F8  |     |     |Vol- |Mute |Vol+ |     |     |
 * |-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----|
 * |     | F1  | F2  | F3  | F4  |     |     |     |     |     |     |     |
 * |-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----+-----|
 * |     |     |     |     |     |           |     |     |     |     |     |
 ...
 */
[2] = {
  {KC_NO,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NO,   KC_NO,   KC_MPRV, KC_MPLY, KC_MNXT, KC_NO,   RESET},
  {KC_NO,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_NO,   KC_NO,   KC_VOLD, KC_MUTE, KC_VOLU, KC_NO,   KC_NO},
