 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |       |Alt/Esc|MO1/Spc|Shf/Bs | Space | Space |Sft/Ent|MO2/Tab|  -_   |       |
 * '-------------------------------------------------------------------------------'
 */
    [0] = {
        ...
        { KC_NO,   ALT_ESC,  MO1_SPC, SFT_BS,  KC_SPC, KC_SPC, SFT_ENT, MO2_TAB, KC_MINS, KC_NO }
    },
/*
 * Layer 1
 * .-------------------------------------------------------------------------------.
 ...
 */
    [1] = {
        ...
        { KC_NO,   KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_0,  KC_PIPE, KC_TRNS, KC_NO   }
    },
/*
 * Layer 2
 * .-------------------------------------------------------------------------------.
